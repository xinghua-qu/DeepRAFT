  ...
  [![Made with python](https://img.shields.io/badge/Python-==3.7.3-blue?logo=python&logoColor=white)]
  [![Made with pytorch](https://img.shields.io/badge/pytorch-==1.10.0-blue?logo=python&logoColor=white)]
  [![Made with torchvision](https://img.shields.io/badge/torchvision-==0.11.0-blue?logo=python&logoColor=white)](https://python.org "Go to Python homepage")
